...
typedef struct php_allocation_functions {
  int check;
  void* (*malloc_fn)(size_t size);
  void* (*calloc_fn)(size_t nmemb, size_t size); /** if NULL, uses malloc_fn then memset */
  void* (*realloc_fn)(void* ptr, size_t size);
  void (*free_fn)(void* ptr);
} php_allocation_functions;

// static php_allocation_functions g_alloc_functions;
...
ZEND_BEGIN_MODULE_GLOBALS(grpc)
  php_allocation_functions g_alloc_functions;
