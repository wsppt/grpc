...
class BaseStub
{
    ...
    {
        return function ($method, $argument, array $metadata = [], array $options = []) use ($channel, $deserialize) {
            $call = new UnaryCall(
                $channel,
                $method,
                $deserialize,
    ...
    {
        return function ($method, array $metadata = [], array $options = []) use ($channel, $deserialize) {
